        ...
        <div class="header">
            ...
            <div class="flex w-full h-28 bg-[#0A2140]">
                ...
                <div class="flex mr-10">
                    <button
                        class="flex items-center text-x1 font-medium text-gray-300 hover:text-gray-700 hover:textborder-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
